...
def main(): 
    ...
    filename = "./output/logs1001_fitCMRprob_K02Behav_poi02.json" # full dataset
    #filename = "./output/logs1001_fitCMRprob_K02Behav_poi02_bottom.json" # bottom half subjects
    #filename = "./output/logs1001_fitCMRprob_K02Behav_poi02_top.json" # top half subjects
