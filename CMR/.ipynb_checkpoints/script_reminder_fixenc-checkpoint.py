...
def main():
    ...
    # define model
    #filename = "./output/logs1001_fitCMRprob_K02Behav_poi02_betaenc"+ str(int(args.enc)) +"_pos" + str(int(args.pos)) + ".json"
    filename = "./output/logs1001_fitCMRprob_K02Behav_poi02_bottom_betaenc"+ str(int(args.enc)) +"_pos" + str(int(args.pos)) + ".json"
    
    # Bounded region of parameter space
    pbounds = {  
        'beta_enc': (float(args.enc)/100,float(args.enc)/100),           # rate of context drift during encoding
    ...
    optimizer.maximize(
        ...
        acq='poi',
        xi=0.05,
        random_state= 10, #random.randint(1,1000000),
