...
def main():
    ...
    filename = "./output/logs0830test_fitCMRprob2modesSim_K02_poi02_largebeta_2stage_primacy" + str(int(args.primacy)) + ".json"
    
    # Bounded region of parameter space
    pbounds = {  
        'beta_enc': (0.5,1),           # rate of context drift during encoding
