...
def main():
    ...
    # define model
    #filename = "./output/logs0311_fitCMRprob_K02Behav_poi02_pos" + str(int(args.pos)) + "_k" + str(int(args.k)) + "_enc" + str(int(args.enc)) +".json"
    filename = "./output/logs0407_fitCMRprob_K02Behav_poi02_pos" + str(int(args.pos)) + "_k" + str(int(args.k)) + "_enc" + str(int(args.enc)) +".json"
