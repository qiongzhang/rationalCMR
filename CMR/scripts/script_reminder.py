...
def main():
    ...
    # define model
    #filename = "./output/logs1001_fitCMRprob_K02Behav_poi02_pos" + str(int(args.pos)) + ".json"
    filename = "./output/logs1001_fitCMRprob_K02Behav_poi02_bottom_pos" + str(int(args.pos)) + ".json"
